...
<sub>✦ TRANSFORMANDO CURIOSIDADE EM CÓDIGO ✦</sub>
...
Para mim, programação é um processo contínuo:

<div align="center">

**IDEIA** → **CÓDIGO** → **ERRO** → **SOLUÇÃO** → **APRENDIZADO** → **EVOLUÇÃO**
...
Trabalho com desenvolvimento web buscando criar sites que combinem:
...
Meu objetivo é transformar necessidades em **soluções digitais funcionais e visualmente interessantes**.
...
**Mais projetos • Mais experiência • Mais conhecimento**
...
`DESIGN` • `RESPONSIVIDADE` • `FUNCIONALIDADE`
...
<sub>A jornada está apenas começando.</sub>
